...
export default function About() {
  ...
  const paragraphs = [
    ...
    `Şanlıurfa Plise Perde Fiyatları Açılışa Özel İndirim Başladı! Şanlıurfa plise perde fiyatları açılışa özel kampanya kapsamında düzenleniyor. Üreticiden doğrudan tüketiciye mantığıyla aracıları kaldırıyoruz. Ekstra komisyon alan kimse olmadığından siz değerli müşterilerimize en taban fiyattan ulaştırıyoruz. Bu kalitede bu fiyata araştırdığımızda Türkiye’de satan yok! NowArt farkıyla sektördeki tecrübelerimizle en iyi hizmeti Şanlıurfa il ve ilçelerinde vermeye başladık.`,
    `Şanlıurfa’da Toptan Zebra ve Plise Kumaş Fiyatları? Plise perdelerimiz metre karesi KDV dahil 350 TL’den başlayan fiyatlarla nowartplicell.com ve Instagram @nowartplicell adreslerinde satışta. Toptan zebra kumaş fiyatları bayilik alan müşterilerimize ekstra indirimler uygulanıyor. Siz de NowArt Tekstil ailesinin bir üyesi olmak isterseniz bize Whatsapp hattımız üzerinden ulaşabilirsiniz.`,
  ];
